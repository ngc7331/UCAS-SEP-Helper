...
(function() {
    ...
    function register(func, hostname) {
        ...
        console.log(`Registered ${func.name} for ${window.location.hostname}`)
        func();
    }

    /* --- module --- */
    function resourceBulkDownload() {
        console.warn("course.ucas.ac.cn is deprecated");
    ...
    function fixCORS() {
        ...
        submit_btn.addEventListener("click", () => {
            var form = document.querySelector("#main-content > div > div.m-cbox.m-lgray > div.mc-body > form");
            form.submit();
        })
    }
    ...
    register(coursePoll, ["xkcts.ucas.ac.cn", "jwxk.ucas.ac.cn"]);
    register(fixCORS, ["xkcts.ucas.ac.cn", "jwxk.ucas.ac.cn"]);
})();
